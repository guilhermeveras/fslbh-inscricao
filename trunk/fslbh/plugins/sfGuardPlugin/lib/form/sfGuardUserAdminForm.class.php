...
class sfGuardUserAdminForm extends BasesfGuardUserForm
{
  ...
  public function configure()
  {
    ...
    $this->mergePostValidator(new sfValidatorSchemaCompare('password', sfValidatorSchemaCompare::EQUAL, 'password_again', array(), array('invalid' => 'As senhas não conferem.')));
