...
/**
* Máscaras de Digitação em Formulários
**/
...
function soNumeros(v) { //Somente Números
...
function cpf(v) { //Máscara para CPF
    v = v.replace(/\D/g, "") //Remove tudo o que não é dígito
...
function cep(v) { //Máscara para CEP
    v = v.replace(/\D/g, "") //Remove tudo o que não é dígito
...
/* Função para focus e para helper */

Event.observe(window, 'load', function() {

        var fields = $$("input");
        var qtd = fields.length;
        for (var i = 0; i <  qtd; i++)
        {
                fields[i].onfocus = function()
                {
                        this.className += ' focused';
                        irmao = this.nextSibling.nextSibling;
                        irmao.style.display="block";
                        pai = this.parentNode.parentNode;
                        pai.className += ' div-foco';
                }
                ...
                fields[i].onblur = function()
                {
                        ...
                        pai = this.parentNode.parentNode;
                        pai.className = pai.className.replace('div-foco', '');
                }
        }
});