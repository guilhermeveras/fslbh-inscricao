...
class BasesfGuardUserFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'usuarios_trabalho_list'        => new sfWidgetFormPropelChoice(array('model' => 'Trabalho', 'add_empty' => true)),
    ));
    ...
    $this->setValidators(array(
      ...
      'usuarios_trabalho_list'        => new sfValidatorPropelChoice(array('model' => 'Trabalho', 'required' => false)),
    ));
  ...
  public function addUsuariosTrabalhoListColumnCriteria(Criteria $criteria, $field, $values)
  {
    ...
    $criteria->addJoin(UsuariosTrabalhoPeer::USUARIO_ID, sfGuardUserPeer::ID);

    $value = array_pop($values);
    $criterion = $criteria->getNewCriterion(UsuariosTrabalhoPeer::TRABALHO_ID, $value);

    foreach ($values as $value)
    {
      $criterion->addOr($criteria->getNewCriterion(UsuariosTrabalhoPeer::TRABALHO_ID, $value));
    }
