...
class BasesfGuardUserForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'usuarios_trabalho_list'        => new sfWidgetFormPropelChoiceMany(array('model' => 'Trabalho')),
    ));
    ...
    $this->setValidators(array(
      ...
      'usuarios_trabalho_list'        => new sfValidatorPropelChoiceMany(array('model' => 'Trabalho', 'required' => false)),
    ));
  ...
  public function saveUsuariosTrabalhoList($con = null)
  {
    ...
    $c = new Criteria();
    $c->add(UsuariosTrabalhoPeer::USUARIO_ID, $this->object->getPrimaryKey());
